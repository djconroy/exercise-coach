...
//        super(context, null, null, DATABASE_VERSION);
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_PRESCRIBED_EXERCISES_TABLE =
            "CREATE TABLE " + PrescribedExercisesEntry.TABLE_NAME
...
//        Log.v(LOG_TAG, SQL_CREATE_PRESCRIBED_EXERCISES_TABLE);
        ...
        final String SQL_CREATE_EXERCISE_CALENDAR_TABLE =
            "CREATE TABLE " + ExerciseCalendarEntry.TABLE_NAME
